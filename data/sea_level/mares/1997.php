...
<title>
Data and Station Information for INHAMBANE</title>
...
<center>
<a href="../met.monthly.data/1997.metdata">Download metric sea level data.  Use only with extreme caution.</a>
</center>
</div>

<div class="indiv_stat">
  <h2>Additional Data Sources (<a href="data_source_guide.php">guide to additional data sources</a>)</h2>
Nearby GNSS Stations from SONEL: <a href="http://www.sonel.org/spip.php?page=gps&idStation=2958" target="_blank">INHB</a><br>
...
<div class="docuheader"><h3>Documentation added 1997-10-08</h3>Gauge type=A. Ott R20</div><div class="docuheader"><h3>Documentation added 2002-01-03</h3>Inhambane tide gauge no longer working (from National report 2001).</div></div>
